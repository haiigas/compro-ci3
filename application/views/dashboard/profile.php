        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <p><a href="<?php echo base_url('create/profile');?>" class="btn btn-primary">Tambah</a></p>
                        ...
                        <div class="col-md-12">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php $no = 0; foreach($profile as $data): $no++; ?>
                                    <tr>
                                        <td><?php echo $no;?></td>
                                        ...
                                        <td><a href="<?php echo base_url('update/profile/'.$data->id);?>" class="btn btn-sm btn-primary">Edit</a> <a href="<?php echo base_url('delete/profile/'.$data->id);?>" class="btn btn-sm btn-danger">Hapus</a></td>
                                    </tr>
                                    <?php endforeach;?>
                                </tbody>
                            </table>
