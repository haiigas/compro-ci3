                ...
                <div class="container-fluid px-4">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-3">
                            <label>Judul</label>
                            <input type="text" name="judul" value="<?php echo $profile->judul;?>" class="form-control" placeholder="Judul">
                        </div>
                        <div class="form-group mb-3">
                            <label>Slug</label>
                            <input type="text" name="slug" value="<?php echo $profile->slug;?>" class="form-control" placeholder="Slug">
                        </div>
                        <div class="form-group mb-3">
                            <label>Konten</label>
                            <textarea class="form-control" name="konten" placeholder="Konten"><?php echo $profile->konten;?></textarea>
                        </div>
                        <div class="form-group mb-3">
